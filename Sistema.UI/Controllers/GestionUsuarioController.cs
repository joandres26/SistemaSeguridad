...
namespace Sistema.UI.Controllers
{
    public class GestionUsuarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idUsuario,Nombre,Apellido1,Apellido2,Contrasenia,IdRol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idUsuario,Nombre,Apellido1,Apellido2,Contrasenia,IdRol")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
